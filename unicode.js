...
let swappedString =
  String.fromCharCode(inputString2.charCodeAt(5)) +
  String.fromCharCode(inputString2.charCodeAt(1)) +
  String.fromCharCode(inputString2.charCodeAt(2)) +
  String.fromCharCode(inputString2.charCodeAt(3)) +
  String.fromCharCode(inputString2.charCodeAt(4)) +
  String.fromCharCode(inputString2.charCodeAt(0)); // Your code here
